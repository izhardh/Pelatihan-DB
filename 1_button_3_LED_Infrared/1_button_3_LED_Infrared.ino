...
void loop() {
  ...
  //Logic
  //Logic 1
  if(bacaTombol1==0 and kunci1==0){
    delay(50);
    digitalWrite(R,HIGH);
    kunci1=1;
    
  }else if(bacaTombol1==0 and kunci1==1){
    delay(50);
    digitalWrite(R,LOW);
    kunci1=0;
  }
...
//Logic 2
  if(bacaTombol2==0 and kunci1==0){
    delay(50);
    digitalWrite(Y,HIGH);
    kunci1=1;
    
  }else if(bacaTombol2==0 and kunci1==1){
    delay(50);
    digitalWrite(Y,LOW);
    kunci1=0;
  }
...
//  //Logic 3
  if(bacaTombol3==0 and kunci1==0){
    delay(50);
    digitalWrite(G,HIGH);
    kunci1=1;
    
  }else if(bacaTombol3==0 and kunci1==1){
    delay(50);
    digitalWrite(G,LOW);
    kunci1=0;
  }  
